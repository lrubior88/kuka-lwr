...
class CartCoupling(object):
  def __init__(self):
    ...
    self.gripper_pub = rospy.Publisher('/lwr/gripper/command', Float64)
    self.ik_cmd_pub = rospy.Publisher('/lwr/ik_command', PoseStamped)
    rospy.Subscriber('/lwr/raw_ik_command', PoseStamped, self.pose_cb)
